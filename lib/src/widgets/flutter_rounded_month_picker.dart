...
class _FlutterRoundedMonthPickerState extends State<FlutterRoundedMonthPicker>
  ...
  Widget _buildItems(BuildContext context, int index) {
    ...
    return FlutterRoundedDayPicker(
      ...
      isScrollVertical: widget.isScrollVertical,
    );
  }
            ...
            child: NotificationListener<ScrollStartNotification>(
              ...
              child: NotificationListener<ScrollEndNotification>(
                ...
                child: PageView.builder(
                  ...
                  scrollDirection: widget.isScrollVertical == true
                      ? Axis.vertical
                      : Axis.horizontal,
          ...
          PositionedDirectional(
            ...
            child: Semantics(
              ...
              child: FadeTransition(
                ...
                child: widget.isScrollVertical == true
                    ? SizedBox.shrink()
                    : IconButton(
                        icon: Icon(
                          Icons.chevron_left,
              ...
              child: FadeTransition(
                ...
                child: widget.isScrollVertical == true
                    ...
                    : IconButton(
                        ...
                        onPressed: () async => _isDisplayingLastMonth
                            ? null
                            : await _handleNextMonth(),
                      ),
              ),
            ),
          ),
